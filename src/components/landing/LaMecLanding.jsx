      ...
      <section className={`relative ${SECTION}`}>
        <div className={INNER}>
          ...
          <div className="mt-14 grid gap-6 md:grid-cols-3">
            <FeatureCard i={0} bareIcon icon={<img src={iconZero} alt="" className="h-16 w-16 object-contain" />} title="Zéro Saisie" text="Oubliez la micro-gestion administrative. Nous collectons et traitons vos flux via Odoo quotidiennement." />
            <FeatureCard i={1} bareIcon icon={<img src={iconTrending} alt="" className="h-16 w-16 object-contain" />} title="Temps Réel" text="Visibilité totale sur votre cash-flow, vos marges et votre trésorerie à l'instant T." />
            <FeatureCard i={2} bareIcon icon={<img src={iconShield} alt="" className="h-16 w-16 object-contain" />} title="Sécurité Totale" text="Conformité fiscale et sociale stricte (France/Maroc), pilotée par nos experts." />
          </div>
        </div>
      </section>
              ...
              <div className="relative overflow-hidden rounded-[28px] bg-white p-7 sm:p-9 ring-1 ring-black/5 shadow-xl min-h-[340px]">
                ...
                <div className="relative">
                  <h3 className="text-[clamp(24px,2.6vw,34px)] font-bold leading-[1.1] text-brand-navy">
                    Frais de setup <span className="text-brand-green-deep">offerts</span><br className="hidden sm:inline" /> pour tous nos résidents.
                  </h3>
                  ...
                  <a href="mailto:contact@lameconseil.com" className="group mt-7 inline-flex items-center gap-2 rounded-full bg-brand-navy px-6 py-3.5 text-sm font-semibold text-white transition-all hover:bg-brand-green-deep">
                    Demander l'offre <ArrowRight className="h-4 w-4 transition-transform group-hover:translate-x-0.5" />
                  </a>
                </div>
              </div>
            </Reveal>
